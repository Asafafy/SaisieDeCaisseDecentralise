...
{
    public partial class CreateUpdateRoles : Form
    {
        // =========================================================================================================
        ...
        // CONSTRUCTEUR ============================================================================================
        // =========================================================================================================
        public CreateUpdateRoles(Home home)
        {
            homeForm = home;
            ...
            dataGridView1.Rows.Add(true, "Contrôle des caisses");
            dataGridView1.Rows.Add(true, "Statistiques des caisses");
        }
        ...
        {
            GestionDesRoles gestionDesRoles = new GestionDesRoles(homeForm);
            homeForm.OpenFormInPanel(gestionDesRoles);
            homeForm.formActif = gestionDesRoles;
            Close();
        }
