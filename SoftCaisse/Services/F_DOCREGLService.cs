...
namespace SoftCaisse.Services
{
    internal class F_DOCREGLService
    {
        ...
        public void InsertNewF_DOCREGL(List<F_REGLEMENTT> listeReglT, string numPieceActu, List<F_COMPTET> listeClients, string typeDocu)
        {
            List<F_DOCREGL> listeDocRegl = _f_DOCREGLRepository.GetAll_F_DOCREGL();
