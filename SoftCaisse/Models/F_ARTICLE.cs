namespace SoftCaisse.Models
{
    ...
    public partial class F_ARTICLE
    {
        ...
        [Column("Objectif / Qtés vendues", TypeName = "numeric")]
        public decimal? Objectif___Qtés_vendues { get; set; }

        [Column("Pourcentage teneur en or", TypeName = "numeric")]
        public decimal? Pourcentage_teneur_en_or { get; set; }

        [Column("1ère commercialisation", TypeName = "smalldatetime")]
        public DateTime? C1ère_commercialisation { get; set; }
    }
}
