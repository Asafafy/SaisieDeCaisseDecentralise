            ...
            if (articleBaseDeDonnees != null)
            {
                ...
                if (Convert.ToInt32(txtBxQuantite.Text) <= quantiteEnStock)
                {
                    ...
                    if (changedIndex == -1)
                    {
                        ...
                        //decimal montantStockSecond;
                        //decimal puStockPrincip;
                        //decimal puStockSecond;
                        //if (_typeDocument == "Devis" || _typeDocument == )
                        //{
                        //    // Type document "devis"
                        //    // Ne rien faire
                        //}
                        ...
                        //        _f_ARTSTOCKService.UpdateAvecCommandeBCOuPL(articleChoisi.AR_Ref, newQteCommandePrincip);
                        //        if (resteACompleter > 0)
                        //        {
                        //            puStockSecond = (decimal)(artStockSecond.AS_MontSto / (artStockPrincip.AS_QteSto == 0 ? 1 : artStockPrincip.AS_QteSto));
                        //            qteStockSecond = (int)artStockSecond.AS_QteSto - resteACompleter;
                        //            montantStockSecond = qteStockSecond * puStockSecond;
                        //            decimal? newQteCommandeSecond = (decimal)(artStockSecond.AS_QteCom + resteACompleter);
                        //            _f_ARTSTOCKService.UpdateStockSecondAvecCommandeBCOuPL(articleChoisi.AR_Ref, qteStockSecond, montantStockSecond, newQteCommandeSecond);
                        //        }
                        ...
                        //        decimal? newQteCommandePrincip = artStockPrincip.AS_QteSto + Convert.ToInt32(txtBxQuantite.Text);
                        //        _f_ARTSTOCKService.UpdateStockPrincipAvecCommandeBCOuPL(articleChoisi.AR_Ref, qteStockPrincip, montantStockPrincip, newQteCommandePrincip);
                        //        _context.Entry(artStockPrincip).Reload();
                        //    }

                        //}
                        //else
                        //// typeDocument "Bon de livraison", "Bon de retour", "Bon d'avoir finanicier", "Facture", "Facture comptabilisée", "Facture de retour", "Facture d'avoir"
                        //{
                        //    if (Convert.ToInt32(txtBxQuantite.Text) > artStockPrincip.AS_QteSto)
                        //    {
                        //        // Cas stock principal insuffisant
                        ...
                        //            qteStockSecond = (int)artStockSecond.AS_QteSto - resteACompleter;
                        //            montantStockSecond = (decimal)(qteStockSecond * artStockSecond.AS_MontSto);
                        //            _f_ARTSTOCKService.UpdateStockSecondAutres(articleChoisi.AR_Ref, qteStockSecond, montantStockSecond);
                        //        }
                        //        _context.Entry(artStockPrincip).Reload();
                        //        _context.Entry(artStockSecond).Reload();
                        //    }
                        ...
                        //        qteStockPrincip = Convert.ToInt32(artStockPrincip.AS_QteSto) - Convert.ToInt32(txtBxQuantite.Text);
                        //        montantStockPrincip = qteStockPrincip * puStockPrincip;
                        //        _f_ARTSTOCKService.UpdateStockPrincipAutres(articleChoisi.AR_Ref, qteStockPrincip, montantStockPrincip);
                        //        _context.Entry(artStockPrincip).Reload();
                        //    }
                        //}
                        ...
                        //if (_typeDocument == "Devis" || _typeDocument == "Bon de commande")
                        //{
                        //    // Ne rien faire
                        //}
                        //else if (_typeDocument == "Préparation de livraison")
                        //{
